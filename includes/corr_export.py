...
def gis_corr_out(filename, corr_gis_path, corr_img_path, arcgrdval, colrng, i, x, y, z, xi2, yi2, min_x, max_x, min_y, max_y, arccxpnts, arccypnts, blank):  
    
    print 'Exporting calibrated GIS grid: column', -2+i
    flusher()
    #Grid data    
    ...
    output_name = corr_gis_path + '/' + filename[0:-4] + '_' + ext + '.asc'
    output = open(output_name, 'w')
    
    proj_name = corr_gis_path + '/' + filename[0:-4] + '_' + ext + '.prj'
    ...
    #Iternate through rows, top to bottom to get correct orientation
    R = 0
